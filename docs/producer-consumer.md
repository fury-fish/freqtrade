        ...
        "producers": [
            {
                ...
                "port": 8000, // The port from your producer's api_server config
...
| `producers.port` | **Required.** The port matching the above host.<br>*Defaults to `8000`.*<br> **Datatype:** Integer
